...
//        TypedQuery<Child> typedQuery = em.createQuery("select c from org.revo.domain.Child c where founded = :founded and age between :age1 and :age2 and addresses.locationName=:location order by date desc  ", Child.class)
